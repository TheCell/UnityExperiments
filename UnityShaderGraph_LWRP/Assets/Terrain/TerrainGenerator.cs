...
{
    [SerializeField] private int tileCountX = 200;
	[SerializeField] private int tileCountZ = 200;
	[SerializeField] private float width = 100.0f;
	[SerializeField] private float length = 100.0f;
	[SerializeField] private float height = 70.0f;
	[SerializeField] private float worldHighlightScale = 0.03f;
