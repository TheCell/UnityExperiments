...
public class MovingSphereSurfaceForCamera : MonoBehaviour
{
	[SerializeField]
	...
	[SerializeField, Range(0f, 100f)]
	private float maxAcceleration = 10f, maxAirAcceleration = 0f;
	[SerializeField, Range(0f, 10f)]
	private float jumpHeight = 2f;
	[SerializeField, Range(0, 5)]
	int maxAirJumps = 0;
	[SerializeField, Range(0, 90)]
	private float maxGroundAngle = 40f, maxStairsAngle = 50f;
	[SerializeField, Range(0f, 100f)]
